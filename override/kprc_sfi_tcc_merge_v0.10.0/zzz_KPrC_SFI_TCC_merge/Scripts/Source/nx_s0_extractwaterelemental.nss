...
/*
	...
	Being immune to Death Magic shouldn't block this spell.
	Only non-living creatures (Undead and Constructs) are immune.
...
void main()
{
	...
	// Things immune to death effects are immune to this spell.	
	...
	if(GetRacialType(oTarget) == RACIAL_TYPE_UNDEAD || GetRacialType(oTarget) == RACIAL_TYPE_CONSTRUCT)
	{
		...
		FloatingTextStringOnCreature("Only living creatures can be affected.", oCaster, FALSE);	// "Target is immune to that effect."
		return;
	}
