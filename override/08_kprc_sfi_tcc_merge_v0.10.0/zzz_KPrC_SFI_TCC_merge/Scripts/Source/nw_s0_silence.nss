...
/*
    ...
    Changed from STANDARDHOSTILE to SELECTIVEHOSTILE so 
    friendly targets don't require a Spell-resistance check 
    or a saving throw anymore.
...
// End of Spell Cast Hook
	...
	{
	    if ( spellsIsTarget(oTarget, SPELL_TARGET_SELECTIVEHOSTILE, OBJECT_SELF) )// Was STANDARDHOSTILE.
	    {
