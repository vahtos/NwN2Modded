...
/*
    ...
    Correctly capped at 1d6 + 15 max.
...
// End of Spell Cast Hook
    ...
    {
        eShield = EffectDamageShield(nDamageAmount, DAMAGE_BONUS_6, DAMAGE_TYPE_FIRE);
    }
    else
    {
        eShield = EffectDamageShield(nDamageAmount, DAMAGE_BONUS_1d6, DAMAGE_TYPE_FIRE);
    }
