...
/*
	...
	(maximum of +5). Lasts 1 hour per level
*/
//:://////////////////////////////////////////////
...
//:: 2012 july 25
//:: - changed IPPolicy for Enhance. -> replace, false, false.
//:: 2016 sept 10
...
/*	Spellcast Hook Code
	...
	if (GetIsObjectValid(oMyWeapon))
	{
		...
		if (fDur > 0.f)
		{
			if (GetIsObjectValid(oPossessor))
			{
				effect eVis = EffectVisualEffect(VFX_DUR_SPELL_GREATER_MAGIC_WEAPON);
				eVis = SupernaturalEffect(eVis);
				ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eVis, oPossessor, fDur);
			}

			itemproperty ipEnhance = ItemPropertyEnhancementBonus(iEnhanc);
			IPSafeAddItemProperty(oMyWeapon, ipEnhance, fDur, X2_IP_ADDPROP_POLICY_REPLACE_EXISTING);
