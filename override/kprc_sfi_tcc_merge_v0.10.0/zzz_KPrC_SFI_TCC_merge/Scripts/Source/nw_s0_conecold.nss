...
//////////////////////////////////////////////////
//:: Update RedRover 5/14/12                    //
//:: Changed length of spell to reflect changes //
//:: made in Reeron's Spell Fixes; SR fix       //
//:: for caster was already made here           //
//////////////////////////////////////////////////
...
// End of Spell Cast Hook
    ...
    while(GetIsObjectValid(oTarget))
    {
     ...
     //            if((GetSpellId() == 340 && !GetIsFriend(oTarget)) || GetSpellId() == 25)
        ...
        //oTarget = GetNextObjectInShape(SHAPE_SPELLCONE, 11.0, lTargetLocation, TRUE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE); //replacing with Reeron's spellshape
        oTarget = GetNextObjectInShape(SHAPE_SPELLCONE, 18.288, lTargetLocation, TRUE, OBJECT_TYPE_CREATURE | OBJECT_TYPE_DOOR | OBJECT_TYPE_PLACEABLE);
    }
	fMaxDelay += 0.5f;
	effect eCone = EffectNWN2SpecialEffectFile("SP_ICE_CONE");
