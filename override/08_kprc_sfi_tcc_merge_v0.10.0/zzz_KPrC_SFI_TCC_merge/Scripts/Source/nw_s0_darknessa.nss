...
/*
    ...
    Changed duration to permanent as the effect should not wear off 
    unless you leave the AOE or the AOE goes away. Either way will 
    call the Darkness (on-exit) script, which will properly remove the effects.
