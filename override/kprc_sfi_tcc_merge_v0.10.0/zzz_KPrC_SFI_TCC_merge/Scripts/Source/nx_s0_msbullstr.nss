...
Can't stack this spell with Bull's Strength anymore.
...
// End of Spell Cast Hook
	...
	while (GetIsObjectValid(oTarget))
	{
		if (spellsIsTarget(oTarget, SPELL_TARGET_ALLALLIES, OBJECT_SELF))
		{
    		...
    		if (GetHasSpellEffect(9, oTarget) || GetHasSpellEffect(1025, oTarget))// Spell 9 is Bull's Strength in Spells.2da. 1025 is Mass Bull's Strength.
    			{
    			FloatingTextStringOnCreature("You can't stack Bull's Strength", OBJECT_SELF);
    			}
    		if (!GetHasSpellEffect(9, oTarget) && !GetHasSpellEffect(1025, oTarget))
    			{
