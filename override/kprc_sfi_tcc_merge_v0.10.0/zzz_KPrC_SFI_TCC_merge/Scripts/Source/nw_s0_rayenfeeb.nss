...
//:: No saving throw anymore.
//::
//:: Reeron modifed 3-4-07
//:: Now lasts 1 minute per level
//:: as per PnP rules.
//:: Won't stack effects anymore.
//::
//:: Reeron modified on 6-7-07
//:: Can't drop strength to below 1 
//:: as per PnP.
    ...
    if (spellsIsTarget(oTarget, SPELL_TARGET_STANDARDHOSTILE, OBJECT_SELF))
    {
		...
		{	//Make SR check
        	...
        	{	//Enter Metamagic conditions
                ...
                int nStrength = GetAbilityScore(oTarget, 0);// integer 0 is Strength.
				if( (nStrength - nLoss) <1)
                    {
                    nLoss = (nStrength - 1);
                    }
