...
/*
	...
	Reeron modified on 12-2-07
	Damage is calculated for each target seperately now. Previously, 
	the script was calculating damage once, then applying it to all targets.
